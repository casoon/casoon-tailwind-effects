...
/**
 * @casoon/tailwindcss-gradients - Tailwind CSS Plugin (CommonJS)
 * 
 * Beautiful gradient utilities for Tailwind CSS v4
 */
function gradientsPlugin(options = {}) {
  return {
...
module.exports.gradientsPlugin = gradientsPlugin;
module.exports.default = gradientsPlugin;