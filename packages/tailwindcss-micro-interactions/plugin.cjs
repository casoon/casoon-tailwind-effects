...
/**
 * @casoon/tailwindcss-micro-interactions - Tailwind CSS Plugin (CommonJS)
 * 
 *  for Tailwind CSS v4
 */
function microinteractionsPlugin(options = {}) {
  return {
...
module.exports = microinteractionsPlugin;
module.exports.microinteractionsPlugin = microinteractionsPlugin;
module.exports.default = microinteractionsPlugin;