...
/**
 * @casoon/tailwindcss-orbs - Tailwind CSS Plugin (CommonJS)
 * 
 * @casoon/tailwindcss-orbs utilities for Tailwind CSS v4
 */
function orbsPlugin(options = {}) {
  return {
...
module.exports = orbsPlugin;
module.exports.orbsPlugin = orbsPlugin;
module.exports.default = orbsPlugin;