...
/**
 * @casoon/tailwindcss-utilities - Tailwind CSS Plugin (CommonJS)
 * 
 * Utility CSS classes for Tailwind CSS v4
 */
function utilitiesPlugin(options = {}) {
  return {
...
module.exports.utilitiesPlugin = utilitiesPlugin;
module.exports.default = utilitiesPlugin;