...
/**
 * @casoon/tailwindcss-loading - Tailwind CSS Plugin (CommonJS)
 * 
 * @casoon/tailwindcss-loading utilities for Tailwind CSS v4
 */
function loadingPlugin(options = {}) {
  return {
...
module.exports.loadingPlugin = loadingPlugin;
module.exports.default = loadingPlugin;